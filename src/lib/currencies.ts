...
export type PaymentCurrency = (typeof PAYMENT_CURRENCIES)[InvoiceCurrency][number];

export function getPaymentCurrenciesForInvoice(invoiceCurrency: InvoiceCurrency): PaymentCurrency[] {
